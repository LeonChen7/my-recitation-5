...
TEST_CASE("Example : Repeat", "[ex-4]") {
  Atm atm;
  atm.RegisterAccount(12345678, 1234, "Sam Sepiol", 300.30);

  REQUIRE_THROWS(atm.RegisterAccount(12345678, 1234, "Leon Chen", 400.30));
...
TEST_CASE("Example: Print Prompt Ledger", "[ex-6]") {
  Atm atm;
  atm.RegisterAccount(12345678, 1234, "Sam Sepiol", 300.30);
  auto& transactions = atm.GetTransactions();
  transactions[{12345678, 1234}].push_back(
...
TEST_CASE("Example : Simple Diposit", "[ex-7]") {
  Atm atm;
  atm.RegisterAccount(12345678, 1234, "Sam Sepiol", 300.30);
